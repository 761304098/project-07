    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name4").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name4").text(name);
                window.parent.parent.$("#price4").css("color","red");
                window.parent.parent.$("#price4").text("￥"+price);
                    ...
                    <div class="row" >
                        <div class="col-xs-6 text-left" style="color: dodgerblue" >
                            ...
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 2%">
                                硬盘容量： <span style="color: black;">${p.rong}GB</span>
                            </div>
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 1%">
                                转速： <span style="color: black;">${p.zhuan}rpm</span>
                            </div>
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 1%;margin-bottom: 2.5%">
                                硬盘尺寸： <span style="color: black;">${p.chi}</span>
                            </div>
                        </div>
                        <div class="col-xs-6 text-right"  style="color: red">
                            ...
                            <div style="color: #8c8c8c;margin-top: 2%" class="text-left">
                                接口类型： <span style="color: black;">${p.jie}</span>
                            </div>
                            <div style="color: #8c8c8c; margin-top: 1%" class="text-left">
                                缓存： <span style="color: black;">${p.huan}</span>
                            </div>
