    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name2").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name2").text(name);
                window.parent.parent.$("#price2").css("color","red");
                window.parent.parent.$("#price2").text("￥"+price);
                    ...
                    <div class="row" >
                        <div class="col-xs-6 text-left" style="color: dodgerblue" >
                            ...
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 2%">
                                主芯片组： <span style="color: black;">${p.group1}</span>
                            </div>
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 1%">
                                主板板型： <span style="color: black;">${p.type}</span>
                            </div>
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 1%;margin-bottom: 2.5%">
                                内存类型： <span style="color: black;">${p.memory}</span>
                            </div>
                        </div>
                        <div class="col-xs-6 text-right"  style="color: red">
                            ...
                            <div style="color: #8c8c8c;margin-top: 2%" class="text-left">
                                CPU插槽： <span style="color: black;">${p.cpuslot}</span>
                            </div>
                            <div style="color: #8c8c8c; margin-top: 1%" class="text-left">
                                集成芯片： <span style="color: black;">${p.chip}</span>
                            </div>
