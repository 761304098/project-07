    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name12").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name12").text(name);
                window.parent.parent.$("#price12").css("color","red");
                window.parent.parent.$("#price12").text("￥"+price);
