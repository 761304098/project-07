    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name16").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name16").text(name);
                window.parent.parent.$("#price16").css("color","red");
                window.parent.parent.$("#price16").text("￥"+price);
                    ...
                    <div class="row" >
                        <div class="col-xs-6 text-left" style="color: dodgerblue" >
                            ...
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 2%">
                                适用网络类型：<span style="color: black;">${p.one}</span>
                            </div>
                            <div style="color: #8c8c8c; padding-left: 10%;margin-top: 1%">
                             总线类型:   <span style="color: black;">${p.three}</span>
                            </div>
                        ...
                        <div class="col-xs-6 text-right"  style="color: red">
                            ...
                            <div style="color: #8c8c8c;margin-top: 2%" class="text-left">
                               网线接口类型： <span style="color: black;">${p.two}</span>
                            </div>
                            <div style="color: #8c8c8c; margin-top: 1%" class="text-left">
                               传输速率： <span style="color: black;">${p.four}</span>
                            </div>
