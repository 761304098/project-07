    ...
    <div class="row row-centered">
        <div class="well col-md-6 col-centered">
            <div style="text-align: center ; margin-bottom: 20px">
                <h1>散件攒机注册系统  <small>V 11-6</small></h1>
            </div>
            ...
            <form action="register" method="get" role="form" onsubmit="return check()" >
                ...
                <div class="input-group input-group-md " id="div-password1" style="margin-top: 20px">
                    ...
                    <input required type="password" class="form-control" id="password1" name="password1" placeholder="请输入密码"/>
                </div>
                ...
                <div class="input-group input-group-md " id="div-idCard" style="margin-top: 20px">
                    ...
                    <input  required type="text" class="form-control" id="id_card" name="id_card" placeholder="请输入身份证" maxlength="18"/>
                </div>
                <br/>
                <button  type="submit" class="btn btn-primary btn-block" id="btn-1"  ><span class="glyphicon glyphicon-log-in"></span>  注册</button>
            </form>
        </div>
