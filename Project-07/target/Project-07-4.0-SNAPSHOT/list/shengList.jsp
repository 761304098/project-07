    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name15").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name15").text(name);
                window.parent.parent.$("#price15").css("color","red");
                window.parent.parent.$("#price15").text("￥"+price);
