    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name14").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name14").text(name);
                window.parent.parent.$("#price14").css("color","red");
                window.parent.parent.$("#price14").text("￥"+price);
