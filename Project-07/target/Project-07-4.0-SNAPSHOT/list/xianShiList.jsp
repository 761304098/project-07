    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name7").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name7").text(name);
                window.parent.parent.$("#price7").css("color","red");
                window.parent.parent.$("#price7").text("￥"+price);
                    ...
                    <div class="row" >
                        ...
                        <div class="col-xs-6 text-right"  style="color: red">
                            ...
                            <div style="color: #8c8c8c;margin-top: 2%" class="text-left">
                                产品类型： <span style="color: black;">${p.lei}</span>
                            </div>
                            <div style="color: #8c8c8c; margin-top: 1%" class="text-left">
                                面板类型： <span style="color: black;">${p.mian}</span>
                            </div>
