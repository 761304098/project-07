    ...
    <script type="text/javascript">
        $(function () {
            $(".btn").click(function (){
                ...
                let namecopy=window.parent.parent.$("#name6").text(); //更改名称前 保存原名称
                ...
                window.parent.parent.$("#name6").text(name);
                window.parent.parent.$("#price6").css("color","red");
                window.parent.parent.$("#price6").text("￥"+price);
                    ...
                    <div class="row" >
                        ...
                        <div class="col-xs-6 text-right"  style="color: red">
                            ...
                            <div style="color: #8c8c8c;margin-top: 2%" class="text-left">
                                显卡芯片： <span style="color: black;">${p.xin}</span>
                            </div>
                            <div style="color: #8c8c8c; margin-top: 1%" class="text-left">
                                显存位宽： <span style="color: black;">${p.wei}</span>
                            </div>
